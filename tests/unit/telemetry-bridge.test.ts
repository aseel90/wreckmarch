...
describe('balance run report bridge contract', () => {
  it('keeps GitHub credentials out of the client and uses the OIDC workflow bridge', () => {
    ...
    expect(pagesWorkflow).toContain('src/phase-c5-runtime.js?v=11&u7=1&wrecker=11');
    expect(pagesWorkflow).toContain('./src/phase-c5-runtime.js?v=11&u7=1&wrecker=11');
    expect(pagesWorkflow).toContain('src/phase-d1-runtime.js?v=30&u5=3&wrecker=11');
    expect(pagesWorkflow).toContain('src/characters/character-runtime-presentation.js?v=11&wrecker=11');

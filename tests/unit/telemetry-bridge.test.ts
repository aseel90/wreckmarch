...
describe('balance run report bridge contract', () => {
  it('keeps GitHub credentials out of the client and uses the OIDC workflow bridge', () => {
    ...
    expect(pagesWorkflow).toContain('./src/phase-c5-runtime.js?v=10&u7=1&wrecker=6');
    expect(pagesWorkflow).toContain('src/phase-d1-runtime.js?v=29');
    expect(pagesWorkflow).toContain('src/characters/character-runtime-presentation.js?v=5&wrecker=6');
    expect(pagesWorkflow).toContain('src/characters/shotgun-production-presentation.js?v=5&wrecker=6');
    expect(pagesWorkflow).toContain('src/characters/shotgun-runtime-presentation.js?v=5');
    ...
    expect(pagesWorkflow).toContain('src/characters/shotgun-locomotion-art.js?v=3');
    expect(pagesWorkflow).toContain('src/characters/shotgun-baked-locomotion.js?v=2');
    expect(pagesWorkflow).toContain('src/characters/shotgun-hand-overlay-bake.js?v=1');

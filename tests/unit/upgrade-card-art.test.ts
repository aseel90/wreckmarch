...
describe('canonical Upgrade System card art', () => {
  it('registers Piercing Rivets in the shared U4 card-art registry', () => {
  ...
  it('routes custom card art through the final D1 card owner without a runtime wrapper', () => {
    ...
    expect(d1).toContain("import { getUpgradeCardArtTexture, installUpgradeCardArt } from './upgrades/upgrade-card-art.js?v=1'");

/* WRECKMARCH R2 — canonical bounded sector terrain for the selected production world. */

export const R2_WORLD_SECTOR_TERRAIN_VERSION = 'r2-sector-terrain-v1';
...
export class WorldSectorTerrain {
  ...
  activateSector(sector) {
    ...
    for (let index = 0; index < 5; index += 1) {
      ...
      debris.setName(`r2-sector-debris-${sector.key}-${index}`);
      objects.push(debris);
    }

...
import { hasCharacterRuntimePresentation } from './character-runtime-presentation.js?v=7&wrecker=8';
...
export const SHOTGUN_PRODUCTION_GATE_VERSION = 'shotgun-production-gate-v6';

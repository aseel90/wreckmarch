...
import { CombatSystem } from '../combat/combat-system.js?v=8';
import { ProjectileSystem } from '../combat/projectile-system.js?v=4';
import { WeaponSystem } from '../combat/weapon-system.js?v=6';
